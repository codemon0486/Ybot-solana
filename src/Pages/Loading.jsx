...
import { INSTAGRAM_CHANNEL_LINK, SITE_URL, TG_CHANNEL, X_CHANNEL_LINK, YOUTUBE_CHANNEL } from '../constants';
                ...
                <div className="loading-launch">
                    ...
                    <div className="loading-launch-bottom">
                        ...
                        <div className="loading-launch-social">
                            ...
                            <ul>
                                <li>
                                    <a className="icon is-telegram" target='_blank' href={SITE_URL}>
                                ...
                                <li>
                                    <a className="icon is-youtube" target='_blank' href={YOUTUBE_CHANNEL}>
                                        <svg
                                            viewBox="0 0 27 20"
                                            fill="none"
                                            xmlns="http://www.w3.org/2000/svg"
