                ...
                <div className="inner">
                    ...
                    <div className="flex flex-col bg-[#15140c] text-center p-4 w-full rounded-2xl gap-4 mt-4">
                        ...
                        <div className="flex items-center">
                            <button className="button button-primary button-default" style={{ flex: '1 1 auto' }}>
                                Invite a friend
                            </button>
                            <button
                            ...
                            <div className="flex flex-col gap-2">
                                {
                                    friends.map((user, index) => (
                                        <div className="flex items-center justify-between rounded-2xl py-1 px-2" key={`friend-users-${index}`} style={{
                                            background: index % 2 === 1 ? '#FFF2' : ''
                                        }}>
                                            <div className="flex items-center gap-2">
                                                <img src="/images/avatars/1.png" alt="avatar img" width={48} />
                                                <p>{user.username}</p>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <div className="">
