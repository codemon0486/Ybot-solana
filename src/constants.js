...
export const LEVEL_POINTS = [0, 5000, 25000, 100000, 1000000, 2000000, 10000000, 50000000, 100000000]

export const BACKEND_URL = IS_PRODUCTION ? "https://monster-kombat-backend.onrender.com" : "http://153.92.211.162:8080";
...
export const TASK_LIST_NAME = ['Youtube', 'Instagram', 'Telegram', 'X', 'Invite Task']
export const TASK_LIST = ['youtube-channel', 'instagram-channel', 'tg-channel', 'x-channel', 'invite-task']
...
export const GAME_DATE = [
    {
        ...
        "overlayImageSecondaryClasses": "absolute -right-6 top-1/2 -translate-y-1/2 w-16 h-16",
        "colors": {
    ...
    },
    {
        ...
        "backgroundImage": "/images/slider/flappy_bird.png",
        "overlayImagePrimary": "/images/slider/fpap_1.svg",
        "overlayImagePrimaryClasses": "absolute -top-8 -left-8 w-24 h-24",
        "overlayImageSecondary": "/images/slider/fpap_2.svg",
        "overlayImageSecondaryClasses": "absolute -right-6 top-1/2 -translate-y-1/2 w-16 h-16",
        "colors": {
            "gradient": "bg-gradient-to-r from-green-500 via-green-600 to-green-700"
